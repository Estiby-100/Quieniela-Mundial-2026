-- Migration 014: FIFA Third Place Matrix — Annex C (495 combinations)
-- Generated directly from the official FIFA World Cup 2026 Regulations PDF.
-- DO NOT edit manually. Source: Annexe C, FWC26_regulations_EN.pdf
-- Columns: option_number, groups_key (8 qualifying group letters sorted A→L),
--   winner_a/b/d/e/g/i/k/l_faces = which group's 3rd-place team faces that group's winner.

-- Annex C: 495 combinations — generated from official FIFA PDF
insert into fifa_third_place_matrix
  (option_number, groups_key, winner_a_faces, winner_b_faces, winner_d_faces,
   winner_e_faces, winner_g_faces, winner_i_faces, winner_k_faces, winner_l_faces)
values
